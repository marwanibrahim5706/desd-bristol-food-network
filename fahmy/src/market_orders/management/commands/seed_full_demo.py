    ...
    def handle(self, *args, **options):
        ...
        catalog = {
            producers[0]: [
                ...
                ("Strawberries Punnet", Decimal("4.50"), 28, "500g punnet", "https://images.unsplash.com/photo-1464965911861-746a04b4bca6?auto=format&fit=crop&w=1200&q=80", "fruit_veg", True, Decimal("6.0"), "seasonal", 6, 8, "", "Sweet summer strawberries picked for desserts, breakfast bowls, and market grazing."),
                ("Seasonal Greens", Decimal("6.00"), 24, "1kg bundle", "https://images.unsplash.com/photo-1576045057995-568f588f82fb?auto=format&fit=crop&w=1200&q=80", "fruit_veg", True, Decimal("5.8"), "seasonal", 4, 10, "", "Leafy seasonal greens for stir-fries, soups, sides, and fresh lunch plates."),
                ("Courgettes Box", Decimal("9.00"), 18, "12 courgettes", "https://images.unsplash.com/photo-1596181525841-8e8bae173eb0?auto=format&fit=crop&w=1200&q=80", "fruit_veg", True, Decimal("6.4"), "seasonal", 6, 9, "", "Tender courgettes for grilling, roasting, pasta dishes, and vegetable bakes."),
                ("Beetroot Bunch", Decimal("5.50"), 16, "6 beetroot", "https://images.unsplash.com/photo-1593105544559-ecb03bf76f82?auto=format&fit=crop&w=1200&q=80", "fruit_veg", True, Decimal("7.2"), "seasonal", 7, 11, "", "Earthy beetroot bunches for roasting, salads, pickling, and colourful sides."),
            ],
            producers[1]: [
                ...
                ("Double Cream", Decimal("2.60"), 35, "300ml pot", "https://images.unsplash.com/photo-1628088062854-d1870b4553da?auto=format&fit=crop&w=1200&q=80", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Rich double cream for desserts, sauces, soups, and weekend baking."),
                ("Soured Cream", Decimal("2.20"), 30, "250ml tub", "https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=1200&q=80", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Tangy soured cream for dips, tacos, baked potatoes, and dressings."),
                ("Halloumi Slices", Decimal("4.40"), 20, "225g pack", "https://images.unsplash.com/photo-1552767059-ce182ead6c1b?auto=format&fit=crop&w=1200&q=80", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Firm halloumi slices for grilling, salads, wraps, and warm lunch bowls."),
                ("Kefir Bottle", Decimal("3.20"), 26, "500ml bottle", "https://images.unsplash.com/photo-1550583724-b2692b85b150?auto=format&fit=crop&w=1200&q=80", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Cultured kefir with a clean tang, useful for smoothies and breakfast bowls."),
                ("Soft Cheese Tub", Decimal("3.40"), 24, "300g tub", "https://images.unsplash.com/photo-1452195100486-9cc805987862?auto=format&fit=crop&w=1200&q=80", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Smooth soft cheese for spreading, dips, sauces, and savoury baking."),
            ],
            producers[2]: [
                ...
                ("Sourdough Loaf", Decimal("4.50"), 20, "1 large loaf", "https://images.unsplash.com/photo-1585478259715-876acc5be8eb?auto=format&fit=crop&w=1200&q=80", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten", "Slow-fermented sourdough with a crisp crust for sandwiches, toast, and sharing boards."),
                ("Cinnamon Buns", Decimal("8.00"), 18, "4 buns", "https://images.unsplash.com/photo-1509365465985-25d11c17e812?auto=format&fit=crop&w=1200&q=80", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten, Milk, Eggs", "Soft cinnamon buns with a light glaze, baked for breakfast treats and coffee breaks."),
                ("Baguette Pair", Decimal("3.60"), 25, "2 baguettes", "https://images.unsplash.com/photo-1608198093002-ad4e005484ec?auto=format&fit=crop&w=1200&q=80", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten", "Two crisp baguettes for sandwiches, soups, cheese boards, and picnic lunches."),
                ("Seeded Rolls", Decimal("4.80"), 24, "8 rolls", "https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=1200&q=80", "bakery", True, Decimal("3.5"), "all_year", None, None, "Gluten, Sesame", "Seeded rolls with a soft crumb for lunch service, burgers, and packed meals."),
            ],
        }
