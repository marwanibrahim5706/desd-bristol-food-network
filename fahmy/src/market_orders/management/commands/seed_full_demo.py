...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        catalog = {
            producers[0]: [
                ("Apples Box", Decimal("18.00"), 50, "24 apples", "https://www.shutterstock.com/image-photo/crate-full-apples-red-shiny-600nw-2691202315.jpg", "fruit_veg", True, Decimal("8.5"), "seasonal", 9, 11, "", "Crisp seasonal apples grown close to Bristol, ideal for snacking, baking, and lunch boxes."),
                ("Carrots Bag", Decimal("8.00"), 35, "2kg bag", "https://farmgatellangrannog.co.uk/wp-content/uploads/2023/07/BFB4EE76-EF11-45CB-8453-78341E8214E1.jpeg", "fruit_veg", True, Decimal("6.2"), "seasonal", 6, 11, "", "Sweet local carrots with a firm crunch, perfect for roasting, soups, and fresh salads."),
                ("Potatoes Sack", Decimal("12.00"), 25, "5kg sack", "https://globebag.com/cdn/shop/articles/K1LkOqLzc3J1qoHwdJaPiXqyT1u52Ty51630702810.jpg?v=1662487151", "fruit_veg", False, Decimal("7.0"), "all_year", None, None, "", "All-round potatoes for mashing, baking, roasting, and weekly kitchen prep."),
                ("Tomatoes Crate", Decimal("14.00"), 4, "3kg crate", "https://jabalyest.com/wp-content/uploads/2024/02/02عبوات-كرتون-بندورة-.jpg", "fruit_veg", True, Decimal("5.5"), "seasonal", 6, 9, "", "Juicy summer tomatoes with bright flavour for salads, sauces, sandwiches, and roasting."),
                ("Eggs Tray", Decimal("7.20"), 3, "30 eggs", "https://ttsmeatsfactoryshop.com/cdn/shop/products/Eggs30Tray1200x800_9ebb4c41-2ad8-457e-aefa-5f771c1791b4.png?v=1612275419", "eggs", True, Decimal("9.0"), "all_year", None, None, "Eggs", "Free range eggs with bright yolks, useful for breakfasts, baking, and protein-rich meals."),
                ("Strawberries Punnet", Decimal("4.50"), 28, "500g punnet", "https://boxedfreshveg.co.uk/cdn/shop/products/STOREStrawberriesPunnet_whitebackdrop_webres_f184d7d0-d8bb-4117-b37b-4a2b31bce396_1024x.jpg?v=1604681536", "fruit_veg", True, Decimal("6.0"), "seasonal", 6, 8, "", "Sweet summer strawberries picked for desserts, breakfast bowls, and market grazing."),
                ("Seasonal Greens", Decimal("6.00"), 24, "1kg bundle", "https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=1200&q=80", "fruit_veg", True, Decimal("5.8"), "seasonal", 4, 10, "", "Leafy seasonal greens for stir-fries, soups, sides, and fresh lunch plates."),
                ("Courgettes Box", Decimal("9.00"), 18, "12 courgettes", "https://falmouthfood.coop/userdata/products/8741/8kzkw8zb39v7in5ybut16860kbc6w6hhdjybmkyi-1749817207_thumbnail.jpg", "fruit_veg", True, Decimal("6.4"), "seasonal", 6, 9, "", "Tender courgettes for grilling, roasting, pasta dishes, and vegetable bakes."),
                ("Beetroot Bunch", Decimal("5.50"), 16, "6 beetroot", "https://media.riverford.co.uk/images/beetroot-bunched-1500x1500-a9aecfad91b465af0853d7ce632a6df6.jpg", "fruit_veg", True, Decimal("7.2"), "seasonal", 7, 11, "", "Earthy beetroot bunches for roasting, salads, pickling, and colourful sides."),
            ],
            producers[1]: [
                ("Milk 1L", Decimal("1.80"), 120, "1 litre bottle", "https://mcpress.mayoclinic.org/uploads/2023/10/DairymilkSoymilkAlmondmilkxGettyImages-1217137593.jpg", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Fresh whole milk from a local dairy, ready for breakfast, baking, tea, and coffee."),
                ("Cheese 500g", Decimal("6.50"), 60, "500g block", "https://theethicaldairy.co.uk/sites/default/files/styles/square_large/public/product-images/2021-03/cooking-cheese.jpg?itok=dC9LCw7T", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Rich farmhouse-style cheese with a creamy texture, good for boards, toasties, and cooking."),
                ("Yogurt Pack", Decimal("4.80"), 18, "6 x 125g pots", "https://assets.tmecosys.com/image/upload/t_web_rdp_recipe_584x480_1_5x/img/recipe/ras/Assets/4b31561be59f1a5e02342b21fe212649/Derivates/bf805aabb95b4274eb0888f01a95443264ea1507.jpg", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Creamy yogurt pots for breakfasts, desserts, smoothies, or simple fruit pairings."),
                ("Butter Block", Decimal("3.80"), 7, "250g block", "https://www.grantsofprestwick.co.uk/media/1043/butter-w.jpg?width=720", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Golden butter block for baking, spreading, pan cooking, and finishing vegetables."),
                ("Double Cream", Decimal("2.60"), 35, "300ml pot", "https://gwpriceltd.co.uk/wp-content/uploads/2020/04/GWPrice-Double-cream-min.jpg", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Rich double cream for desserts, sauces, soups, and weekend baking."),
                ("Soured Cream", Decimal("2.20"), 30, "250ml tub", "https://www.biggerbolderbaking.com/wp-content/uploads/2016/09/1C5A7606.jpg", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Tangy soured cream for dips, tacos, baked potatoes, and dressings."),
                ("Halloumi Slices", Decimal("4.40"), 20, "225g pack", "https://images.immediate.co.uk/production/volatile/sites/30/2023/09/Raw-halloumi-sliced-535282d.jpg?quality=90&fit=700,466", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Firm halloumi slices for grilling, salads, wraps, and warm lunch bowls."),
                ("Kefir Bottle", Decimal("3.20"), 26, "500ml bottle", "https://thehomestylecottage.com/wp-content/uploads/2022/02/IMG_4225-677x1024.jpg", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Cultured kefir with a clean tang, useful for smoothies and breakfast bowls."),
                ("Soft Cheese Tub", Decimal("3.40"), 24, "300g tub", "https://bagelsyourwaycafe.com/wp-content/uploads/2021/05/cream-cheese-e1706784642442.png", "dairy", False, Decimal("12.0"), "all_year", None, None, "Milk", "Smooth soft cheese for spreading, dips, sauces, and savoury baking."),
            ],
            producers[2]: [
                ("Fresh Bread", Decimal("3.20"), 80, "1 large loaf", "https://moorlandseater.com/wp-content/uploads/2018/05/no-knead-bread-for-beginners-sliced-on-a-board-moorlands-eater-DSC07055.jpg", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten", "Freshly baked crusty bread for sandwiches, soup lunches, toast, and sharing."),
                ("Croissant Box", Decimal("9.00"), 30, "6 croissants", "https://gails.com/cdn/shop/files/6_Croissants.jpg?v=1776692458&width=1426", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten, Milk, Eggs", "A box of buttery croissants with flaky layers, best for breakfast meetings and treats."),
                ("Wholemeal Loaf", Decimal("3.00"), 22, "1 sliced loaf", "https://www.agaliving.com/sites/default/files/2019-01/Wholemeal%20Rosemary%20and%20Chives%20Bread%20Normal.jpg", "bakery", True, Decimal("3.5"), "all_year", None, None, "Gluten", "Nutty wholemeal loaf baked for everyday sandwiches, toast, and soup pairings."),
                ("Donut Pack", Decimal("7.50"), 14, "6 donuts", "https://images.squarespace-cdn.com/content/v1/5b4fcf569f8770d6bed6ee2e/1661355803413-VO7E0DCG8ACPYVZZLF31/IMG_9201.jpg?format=1000w", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten, Milk, Eggs", "Soft sweet donuts for dessert tables, staff treats, and weekend sharing boxes."),
                ("Brioche", Decimal("4.20"), 2, "1 loaf", "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/brioche-597b5f8.jpg", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten, Milk, Eggs", "Soft enriched brioche with a tender crumb, great for brunch, toast, or puddings."),
                ("Sourdough Loaf", Decimal("4.50"), 20, "1 large loaf", "https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_1:1/k%2FPhoto%2FRecipes%2F2020-01-How-to-Sourdough-Bread%2F98877-sliced-lead_How-to-make-sourdough-bread", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten", "Slow-fermented sourdough with a crisp crust for sandwiches, toast, and sharing boards."),
                ("Cinnamon Buns", Decimal("8.00"), 18, "4 buns", "https://mccormick.widen.net/content/megysgsour/jpeg/Holiday_Cinnamon-Rolls_1376x774.jpeg", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten, Milk, Eggs", "Soft cinnamon buns with a light glaze, baked for breakfast treats and coffee breaks."),
                ("Baguette Pair", Decimal("3.60"), 25, "2 baguettes", "https://lechefswife.com/wp-content/uploads/2021/06/IMG_2521-scaled.jpg", "bakery", False, Decimal("3.5"), "all_year", None, None, "Gluten", "Two crisp baguettes for sandwiches, soups, cheese boards, and picnic lunches."),
                ("Seeded Rolls", Decimal("4.80"), 24, "8 rolls", "https://static01.nyt.com/images/2016/12/07/dining/07KITCH2/07KITCH2-jumbo.jpg", "bakery", True, Decimal("3.5"), "all_year", None, None, "Gluten, Sesame", "Seeded rolls with a soft crumb for lunch service, burgers, and packed meals."),
            ],
        }
