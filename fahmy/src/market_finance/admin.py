...
class SettlementAdmin(admin.ModelAdmin):
    list_display = ("id", "producer", "week_start", "week_end", "gross_sales", "commission_amount", "payout_amount", "status")
    list_filter = ("status", "week_start")
    search_fields = ("producer__username", "producer__business_name")
